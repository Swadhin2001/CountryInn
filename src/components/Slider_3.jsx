                    ...
                    {({ isActive }) => (
                            <div>
                                ...
                                <div className="swiper-data my-4">
                                    ...
                                    <p className='px-3'>{isActive ? `${props.about2}` : ' '} </p>
                                </div>
                            </div>
                        )}
                    </SwiperSlide>
                    ...
                    {({ isActive }) => (
                            <div>
                                ...
                                <div className="swiper-data my-4">
                                    ...
                                    <p className='px-3'>{isActive ? `${props.about3}` : ' '} </p>
                                </div>
                            </div>
                        )}
                    </SwiperSlide>
                        ...
                        {({ isActive }) => (
                            <div>
                                ...
                                <div className="swiper-data my-4">
                                    ...
                                    <p className='px-3'>{isActive ? `${props.about4}` : ' '} </p>
                                </div>
                            </div>
                        )}
                    </SwiperSlide>
                    <SwiperSlide className='carousel  custom-carousel-one'>
                        {({ isActive }) => (
                            <div>
                                ...
                                <div className="swiper-data my-4">
                                    <h4 className='p-3'>{isActive ? `${props.heading5}` : ' '}</h4>
                                    <p className='px-3'>{isActive ? `${props.about5}` : ' '} </p>
                                </div>
                            </div>
                        )}
                    </SwiperSlide>
                    <SwiperSlide className='carousel  custom-carousel-one' >
                        {({ isActive }) => (
                            <div>
                                ...
                                <div className="swiper-data my-4">
                                    <h4 className='p-3'>{isActive ? `${props.heading1}` : ' '}</h4>
                                    <p className='px-3'>{isActive ? `${props.about1}` : ' '} </p>
                                </div>
                            </div>
                        )}
                    </SwiperSlide>
