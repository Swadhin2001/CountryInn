...
function Navbar(props) {
  ...
  return (
    <>
        <div className="navbar navbar-expand-lg bg-body-tertiary sticky-top d-flex align-center justify-content-center bg-light" style = {{"opacity": `${opacity}`}}>
            <div className="container-1140 d-flex flex-row">
