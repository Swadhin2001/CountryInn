...
function bhimtal() {
  return (
    <>
      <Head>
        <title>COUNTRY INN NATURE RESORT, BHIMTAL</title>
      ...
      <Slider_3 heading="STAY & REJUVENATE" image1={slider_image6}
        ...
        about1='For the mountain hideaways, there is nothing more special than staying in cottages that offer a more characterful and private experience. Featuring French windows, wooden flooring and modern amenities, these cottages are spacious, stylish, and an ideal family setting for your next weekend getaway <br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 690 Sq. ft.</span></li><li class="text-start px-3"><img src="/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 4 guests</span></li><li class="text-start px-3"><img src="/View.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Hill View </span></li></ul>'
        image2={slider_image7}
        heading2="TWO BEDROOM COTTAGE"
        about2='Boasting two bedrooms and a spacious living area, a stay in these cottages make your vacation even more inspiring. Relax in your cottage or spend hours sitting in the adjoining lawns offering expansive views of the valley to soak in the real essence of this unmatched destination<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 750 Sq. ft.</span></li><li class="text-start px-3"><img src="/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 4 guests</span></li><li class="text-start px-3"><img src="/View.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Hill View </span></li></ul>'

        image3={slider_image8}
        heading3="DELUXE ROOM"
        about3='Here, you will find the peace and comfort you deserve, along with the charming  views of the mountains. With all the essential amenities, these rooms are the perfect choice for a small family, a couple or corporates looking for simple comfort in an exclusive location<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 280 Sq. ft.</span></li><li class="text-start px-3"><img src="/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li><li class="text-start px-3"><img src="/View.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Garden View </span></li></ul>'
        image4={slider_image9}
        heading4="DELUXE SUITE"
        about4='The spacious and comfortable Deluxe Suites feature a separate living room where you can relax after a long day of exploration. Unwind with your loved ones while enjoying the breath-taking vistas of the beautiful mountains<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 400 Sq. ft.</span></li><li class="text-start px-3"><img src="/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 4 guests</span></li><li class="text-start px-3"><img src="/View.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Hill View </span></li></ul>'
