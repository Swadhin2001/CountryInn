  ...
  return (
    <>
      ...
      <Herosection image = {banner_image} banner_heading = "Country Inn Tarika Goa, Varca Beach" text_color ="text-white" about = {<fragment>
        ...
        heading1 = "PARLOUR POOL VIEW ROOMS" about1 = "Impeccably styled and furnished with contemporary conveniences, our Parlour Pool View Rooms present a harmonious blend of elegance and functionality. Boasting a spacious bedroom, a separate living room, and a private balcony offering picturesque views of the serene pool, this exquisite accommodation is the choice for discerning individuals seeking unparalleled comfort."

        image4 = {slider_image9}image5 = {slider_image10} image6 = {slider_image11}
        heading2 = "GOA CLASSIC POOL VIEW ROOM WITH BALCONY" about2 = "Experience contemporary elegance as you choose to stay in these thoughtfully curated spaces, featuring modern interiors that combine style and comfort seamlessly. Each room offers a private balcony that overlooks the sparkling swimming pool, allowing you to soak in the serene ambiance. To enhance your stay, you'll find amenities such as an LED TV,a tea and coffee maker, and a minibar, ensuring a rejuvenating stay."
        image7 = {slider_image12} image8 = {slider_image13} image9 = {slider_image14}
        heading3 = "GOA CLASSIC ROOM WITH PRIVATE GARDEN"
        about3 = "Enjoy a blissful indulgence with these thoughtfully designed rooms with a private garden so you can make the most of your stay. Embrace the comfort of modern interiors, while a private garden invites you to unwind and relax. Anticipating your every need, these rooms are equipped with an array of amenities that ensure a seamless stay."
        image10 = {slider_image15} image11 = {slider_image16} image12 = {slider_image17}
        heading4 = "GOA CLASSIC ROOM"
        about4 = "Unveil a relaxing stay experience, with modern interiors creating a stylish and inviting ambiance. Stay in convenience with a wardrobe closet to keep your belongings organized, tea/ coffee maker for instant cup of relaxation, while an LED TV ensures entertainment at your fingertips"
        />
