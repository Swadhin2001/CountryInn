...
function amritsar() {
  return (
    <>
      ...
      about1='Elegantly designed with wooden floor and modern interiors, the Heritage Suite offers a spacious accommodation with a separate living area.  It is your perfect abode to unwind and relax after a long day of exploration in the city of Amritsar<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 450 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li></ul>' 
      image2={slider_image7} heading2="DELUXE ROOM" 
      about2='Offering a sense of space, our immaculately appointed Deluxe Rooms feature a king-size bed, a built-in closet, and three fixture bathroom to offer enhanced comfort<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 270 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li></ul>' 
      image3={slider_image8} heading3="SUPERIOR ROOM" 
      about3='Unwind and stay at ease in our Superior Rooms. With modern interiors and a private workstation, these well-appointed rooms are perfect for a relaxing and fulfilling stay<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 250 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li></ul>' 
      image4={slider_image9} heading4="STANDARD ROOM" 
      about4='With our Standard Rooms, you will get comforting interiors and all the basic amenities that you require for a good nights sleep<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 190 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li></ul>' 
      image5={slider_image10} heading5="DELUXE ROOM" 
      about5='Offering a sense of space, our immaculately appointed Deluxe Rooms feature a king-size bed, a built-in closet, and three fixture bathroom to offer enhanced comfort<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 450 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li></ul>'></Slider_3>
