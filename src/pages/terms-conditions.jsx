      ...
      <div className='d-flex justify-content-center'>
        <div className='container-1140 my-5 py-4'>
            ...
            <div>
                ...
                <p>The Company will maintain the confidentiality of each transaction and will not disclose the commercially sensitive information, except to the extent necessary for the services.</p>
            </div>
            <div>
                <h4>6. Promotional Information</h4>
                <p>We may make information regarding specific programs, offers or promotions, which we are conducting, available on the sites. We reserve the right to alter or withdraw any program, offer or promotion at any such time.</p>
            </div>
            <div>
                <h4>7. Limitation of Liability</h4>
                <p>We are not responsible for, and shall have no liability for: (i) telephone, mobile, electronic, network, internet, computer, hardware or software program malfunctions, delays, or failures; (ii) for any injury, loss or damage to your computer or interception or use of credit card information, related to or resulting from use of the site or any sites, services, or materials linked or relating thereto; (iii) any incorrect information, whether caused by other users or by any of the equipment, software, or programming associated with or utilized in the site or as the result of technical or human error which may occur in the processing of information regarding the site.</p>
            </div>
            <div>
                <h4>8. Disclaimers</h4>
                <p>Electronic transmissions, including the internet, are public media, and any use of such media is public and not private. Information related to or arising from such use is public, or the property of those collecting information, and not personal or private information. <br />
            ...
            <div>
                ...
                <p>The products or services described in and available through the site may not be available in your country. We make no representation that the services or products offered on the site are appropriate or available for use in any particular location. <br />
