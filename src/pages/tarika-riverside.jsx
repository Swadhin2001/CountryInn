...
function bhimtal() {
  return (
    <>
      ...
      about1 = 'For a relaxing and serene stay experience in a cottage setting, choose to stay at our selection of Jim’s Cottages. Adorned with the artistic cane furniture, Jim’s Cottages are an ideal choice for your leisurely stay.<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 155 Sq. ft to 330 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li><li class="text-start px-3"><img src="../assets/View.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Multiple Options </span></li></ul>' 
      image2 ={slider_image7} heading2 = "COTTAGE WITH PRIVATE GARDEN" 
      about2 ='These cottages with a private garden are an ideal setting for stress-free holidays. Whether lounging during the day or having a private dinner in the garden, this cottage is our guest’s favourite for its private sit-out area and spacious accommodation<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 370 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li><li class="text-start px-3"><img src="../assets/View.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Pool View </span></li></ul>' 
      image3 ={slider_image8}   heading3 ="COTTAGE WITH TERRACE" 
      about3 = 'The combination of style, space and unfiltered view of the pool from a private terrace make these cottages the most desirable accommodation for a restful stay in Jim Corbett<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 330 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li><li class="text-start px-3"><img src="../assets/View.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Pool View </span></li></ul>' 
      image4 ={slider_image9} heading4 = "COTTAGE WITH PLUNGE POOL" 
      about4 = 'After a day of exploration, all you need is to dip in a plunge pool and relax in your private space for hours. These cottages are beautifully furnished with cane furniture that adds a rustic yet comfortable touch to your stay<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 370 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li><li class="text-start px-3"><img src="../assets/View.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Pool View </span></li></ul>' 
      image5 ={slider_image10} heading5 = "POOL VIEW ROOM" about5 = 'Whether travelling on business or leisure you would want a room that offers plenty of style and comfort. In celebration of your trip, get into a pool of relaxation with a Pool View Room <br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="../assets/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 280 Sq. ft.</span></li><li class="text-start px-3"><img src="../assets/Occ.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Upto 2 guests</span></li><li class="text-start px-3"><img src="../assets/View.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> Pool View </span></li></ul>' ></Slider_3>
