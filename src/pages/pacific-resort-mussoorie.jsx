...
function mussoorie() {
  return (
    <>
      ...
      about1= 'The elegant Pacific Mountain View Suite. offers breath-taking views of the surrounding valley and spectacular hill scenery in the backdrop. The spacious living room with sofa and a dining area is ideal to witness fresh mornings and dreamy sunsets. The suite provides a serene and comfortable retreat for guests seeking a relaxing, upscale experience in the lap of nature<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 650 Sq. ft.</span></li></ul>' 
      image4 = {slider_image9}  image5 = {slider_image10} image6 = {slider_image11} heading2 = "CLUB PREMIER ROOMS WITH BALCONY" 
      about2 ='Indulge in the breathtaking beauty of Mussoorie with our meticulously designed Club Premier Rooms with Balcony and enjoy an elevated experience with club benefits. These rooms feature a seating area, work desk, LED TV, wooden closet and spacious interiors. With Club Premier Rooms, you will get an exclusive access to the ‘Club Premier’ benefits like welcome drink on arrival, early check-in and late check-out, buffet breakfast and dinner, daily hi-tea and much more, to enhance your stay experience. <br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 230 sq. ft to 350 sq. ft.</span></li></ul>' 
      image7 = {slider_image12} image8 = {slider_image13} image9 = {slider_image14}  heading3 = "MOUNTAIN VIEW ROOMS" 
      about3 = 'These exquisitely designed rooms offer scenic views of the surrounding mountains. The rooms are comfortably designed with modern interiors, wooden flooring, a working desk, a seating area, LED TV, and a wooden closet to offer an unforgettable experience for guests seeking a peaceful retreat in the mountains.<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 280 Sq. ft.</span></li></ul>' image10 = {slider_image15} image11 = {slider_image16} image12 = {slider_image17} heading4 = "PACIFIC ROOMS" about4 = 'Thoughtfully designed with comfort in mind, Pacific Rooms feature tasteful interiors with wooden flooring, a working desk, a seating area, LED TV, and modern amenities for a comfortable stay. These rooms are an ideal abode to rest after a busy day of exploration.<br> <br> <ul class="d-flex flex-row justify-content-start room-info mb-2" style="list-style-type: none;"><li class="text-start"><img src="/Area.png" alt="" width="20px" height="20px"> <span class="f-s-16 color-black font-Brandon"> 240 Sq. ft.</span></li></ul>'/> 
      ...
      <Gallery heading = "GALLERY" image1 = {slider_image1} about1 = "Welcoming Lobby" image2 = {slider_image2} about2 = "Valley View" image3 = {slider_image3} about3 ="Pacific Mountain View Suite - Living Room View" image4 = {slider_image4} about4 ="Mountain View Room" image5 = {slider_image5} about5 ="Mesmarising Views"/>
      {/* <Slider_2></Slider_2> */}
